...
var author$project$DebugEmbed$init = {count: 0};
...
var author$project$DebugEmbed$update = F2(
	function (msg, model) {
		return _Utils_update(
			model,
			{count: model.count + 1});
	});
var author$project$DebugEmbed$Increment = {$: 'Increment'};
...
var author$project$DebugEmbed$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$DebugEmbed$Increment),
...
var author$project$DebugEmbed$main = elm$browser$Browser$sandbox(
	{init: author$project$DebugEmbed$init, update: author$project$DebugEmbed$update, view: author$project$DebugEmbed$view});
_Platform_export({'DebugEmbed':{'init':author$project$DebugEmbed$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"DebugEmbed.Msg","aliases":{},"unions":{"DebugEmbed.Msg":{"args":[],"tags":{"Increment":[]}}}}})}});}(this));