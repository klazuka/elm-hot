...
var author$project$DebugFullscreen$init = function (flags) {
	return _Utils_Tuple2(
		{count: flags.n},
		elm$core$Platform$Cmd$none);
};
var author$project$DebugFullscreen$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
...
var author$project$DebugFullscreen$Increment = {$: 'Increment'};
...
var author$project$DebugFullscreen$view = function (model) {
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('DebugFullscreen')
					])),
				A2(
				elm$html$Html$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$DebugFullscreen$Increment),
...
var author$project$DebugFullscreen$main = elm$browser$Browser$document(
	{
		init: author$project$DebugFullscreen$init,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: author$project$DebugFullscreen$update,
		view: author$project$DebugFullscreen$view
	});
_Platform_export({'DebugFullscreen':{'init':author$project$DebugFullscreen$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'n', elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.0"},"types":{"message":"DebugFullscreen.Msg","aliases":{},"unions":{"DebugFullscreen.Msg":{"args":[],"tags":{"Increment":[]}}}}})}});}(this));