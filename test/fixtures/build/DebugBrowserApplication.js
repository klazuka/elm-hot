...
var author$project$DebugBrowserApplication$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var author$project$DebugBrowserApplication$UrlChanged = function (a) {
	return {$: 'UrlChanged', a: a};
};
var author$project$DebugBrowserApplication$NotFound = {$: 'NotFound'};
var author$project$DebugBrowserApplication$Decrementer = {$: 'Decrementer'};
var author$project$DebugBrowserApplication$Incrementer = {$: 'Incrementer'};
var author$project$DebugBrowserApplication$loadPage = F2(
	function (url, model) {
		return _Utils_update(
			model,
			{
				page: function () {
					...
					if (_n0.$ === 'Nothing') {
						return author$project$DebugBrowserApplication$Incrementer;
					} else {
						switch (_n0.a) {
							case '/incrementer':
								return author$project$DebugBrowserApplication$Incrementer;
							case '/decrementer':
								return author$project$DebugBrowserApplication$Decrementer;
							default:
								return author$project$DebugBrowserApplication$NotFound;
						}
					}
				}()
			});
...
var author$project$DebugBrowserApplication$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A2(
				author$project$DebugBrowserApplication$loadPage,
				url,
				{count: flags.n, myNavKey: key, page: author$project$DebugBrowserApplication$NotFound}),
...
var author$project$DebugBrowserApplication$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Increment':
				return _Utils_Tuple2(
			...
			default:
				var url = msg.a;
				return _Utils_Tuple2(
					A2(author$project$DebugBrowserApplication$loadPage, url, model),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$DebugBrowserApplication$Decrement = {$: 'Decrement'};
var author$project$DebugBrowserApplication$Increment = {$: 'Increment'};
var elm$html$Html$h1 = _VirtualDom_node('h1');
var author$project$DebugBrowserApplication$view = function (model) {
		...
		switch (_n0.$) {
			case 'Incrementer':
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$id('incrementer')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Incrementer')
								])),
							A2(
							elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('Counter value is: '),
									A2(
									elm$html$Html$span,
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onClick(author$project$DebugBrowserApplication$Increment),
									elm$html$Html$Attributes$id('counter-button')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('+')
							...
							_List_fromArray(
								[
									elm$html$Html$text('Switch to '),
									A2(
									elm$html$Html$a,
									_List_fromArray(
										[
											elm$html$Html$Attributes$id('nav-decrement'),
											elm$html$Html$Attributes$href('#/decrementer')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('decrementer')
										]))
								]))
						]));
			case 'Decrementer':
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$id('decrementer')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onClick(author$project$DebugBrowserApplication$Decrement),
									elm$html$Html$Attributes$id('counter-button')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$id('nav-increment'),
											elm$html$Html$Attributes$href('#/incrementer')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('incrementer')
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('code-version')
					]),
				_List_fromArray(
					[
						elm$html$Html$text('code: v5')
					])),
				pageBody
			]),
...
var author$project$DebugBrowserApplication$main = elm$browser$Browser$application(
	{
		init: author$project$DebugBrowserApplication$init,
		onUrlChange: author$project$DebugBrowserApplication$UrlChanged,
		onUrlRequest: author$project$DebugBrowserApplication$LinkClicked,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: author$project$DebugBrowserApplication$update,
		view: author$project$DebugBrowserApplication$view
	});
_Platform_export({'DebugBrowserApplication':{'init':author$project$DebugBrowserApplication$main(
	A2(
